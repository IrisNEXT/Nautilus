...
$AppsToRemove = @(
    'AmazonVideo', 'AppUp.IntelManagementandSecurityStatus', 'Clipchamp.Clipchamp',
    'Disney.37853FC22B2CE', 'DolbyLaboratories.DolbyAccess', 'DolbyLaboratories.DolbyDigitalPlusDecoderOEM',
    'Facebook', 'Instagram', 'LinkedInforWindows', 'Microsoft.3DBuilder', 'Microsoft.549981C3F5F10',
    'Microsoft.Advertising', 'Microsoft.BingFinance', 'Microsoft.BingFoodAndDrink', 'Microsoft.BingHealthAndFitness',
    'Microsoft.BingNews', 'Microsoft.BingSearch', 'Microsoft.BingSports', 'Microsoft.BingTravel',
    'Microsoft.BingWeather', 'Microsoft.CommsPhone', 'Microsoft.ConnectivityStore', 'Microsoft.Copilot',
    'Microsoft.ECApp', 'Microsoft.Edge.GameAssist', 'Microsoft.GamingApp', 'Microsoft.GamingServices',
    'Microsoft.GetHelp', 'Microsoft.Getstarted', 'Microsoft.Messaging', 'Microsoft.Microsoft3DViewer',
    'Microsoft.MicrosoftEdge', 'Microsoft.MicrosoftEdge.Stable', 'Microsoft.MicrosoftEdgeDevToolsClient',
    'Microsoft.MicrosoftOfficeHub', 'Microsoft.MicrosoftPowerBIForWindows', 'microsoft.microsoftskydrive',
    'Microsoft.MicrosoftSolitaireCollection', 'Microsoft.MicrosoftStickyNotes', 'Microsoft.MicrosoftTeamsforSurfaceHub',
    'Microsoft.MinecraftUWP', 'Microsoft.MixedReality.Portal', 'Microsoft.MSPaint', 'Microsoft.Office.Excel',
    'Microsoft.Office.OneNote', 'Microsoft.Office.PowerPoint', 'Microsoft.Office.Word', 'Microsoft.OfficePushNotificationUtility',
    'Microsoft.OneConnect', 'Microsoft.OutlookForWindows', 'Microsoft.Paint', 'Microsoft.People',
    'Microsoft.PowerAutomateDesktop', 'Microsoft.PPIProjection', 'Microsoft.Print3D', 'Microsoft.ScreenSketch',
    'Microsoft.Services.Store.Engagement', 'Microsoft.SkypeApp', 'Microsoft.StartExperiencesApp', 'Microsoft.Todos',
    'Microsoft.Wallet', 'Microsoft.Whiteboard', 'Microsoft.WidgetsPlatformRuntime', 'Microsoft.Windows.AAR',
    'Microsoft.Windows.Apprep.ChxApp', 'Microsoft.Windows.CloudExperienceHost', 'Microsoft.Windows.ContentDeliveryManager',
    'Microsoft.Windows.Copilot', 'Microsoft.Windows.Cortana', 'Microsoft.Windows.DevHome', 'Microsoft.Windows.DiagnosticDataViewer',
    'Microsoft.Windows.HolographicFirstRun', 'Microsoft.Windows.MaintenanceHub', 'Microsoft.Windows.NarratorQuickStart',
    'Microsoft.Windows.Notepad', 'Microsoft.Windows.ParentalControls', 'Microsoft.Windows.PeopleExperienceHost',
    'Microsoft.Windows.Photos', 'Microsoft.Windows.PreviewBuilds', 'Microsoft.Windows.SecondaryTileExperience',
    'Microsoft.Windows.SecureAssessmentBrowser', 'Microsoft.Windows.SensorHost', 'Microsoft.Windows.Teams',
    ...
    'Microsoft.WindowsScan', 'Microsoft.WindowsSoundRecorder', 'Microsoft.WindowsTerminal', 'Microsoft.Xbox',
    'Microsoft.Xbox.TCUI', 'Microsoft.XboxApp', 'Microsoft.XboxGameOverlay', 'Microsoft.XboxGamingOverlay',
    'Microsoft.XboxIdentityProvider', 'Microsoft.XboxSpeechToTextOverlay', 'Microsoft.YourPhone', 'Microsoft.ZuneMusic',
    'Microsoft.ZuneVideo', 'MicrosoftCorporationII.MailforSurfaceHub', 'MicrosoftCorporationII.MicrosoftFamily',
    'MicrosoftCorporationII.QuickAssist', 'MicrosoftTeams', 'MicrosoftWindows.Client.WebExperience',
    'MicrosoftWindows.CrossDevice', 'MSTeams', 'Netflix', 'OutlookPWA', 'SpotifyAB.SpotifyMusic',
    'TikTok', 'Twitter', 'WhatsAppDesktop', 'WinZipUniversal'
)
...
foreach ($App in $AppsToRemove) {
    ...
    if ($TargetPackages) {
        foreach ($Target in $TargetPackages) {
            Write-Host "  - Removed: $($Target.DisplayName)" -ForegroundColor DarkGray
